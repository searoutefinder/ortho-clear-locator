...
const SideBar = ({locations}) => {
  ...
  return (
    <div className="transition-all duration-300 ease-in-out absolute right-0 bottom-0 w-full md:top-20 
    md:h-[calc(100vh-5rem)] md:w-96 bg-[#3b3b3b]/30  backdrop-blur-sm">
      ...
      <div ref={sidebarRef} className={`
        ...
        md:flex-col 
        md:h-screen
        md:max-h-[calc(100vh-5rem)] ${locations.length === 0 ? 'justify-center' : ''}`}
      >
